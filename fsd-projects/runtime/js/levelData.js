    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          { type: "enemy", x: 800, y: groundY - 50, speed: -3, damage: 10},
          { type: "enemy", x: 1000, y: groundY - 50, speed: -2, damage: 10},
          { type: "enemy", x: 1200, y: groundY - 50, speed: -2, damage: 10},
          { type: "enemy", x: 1400, y: groundY - 50, speed: -2, damage: 10},
          { type: "enemy", x: 1500, y: groundY - 50, speed: -2, damage: 10},
          { type: "enemy", x: 1685, y: groundY - 50, speed: -2, damage: 10},
          { type: "reward", x: 1300, y: groundY - 125, speed: -2},
      ...
      },
      {
        ...
        gameItems: [
          ...
          { type: "sawblade", x: 930, y: groundY - 10, damage: 20},
          { type: "sawblade", x: 915, y: groundY - 10, damage: 20},
          { type: "sawblade", x: 1100, y: groundY - 10, damage: 20},
          { type: "enemy", x: 625, y: groundY - 50, speed: -3, damage: 10},
          { type: "enemy", x: 800, y: groundY - 50, speed: -3, damage: 10},
          { type: "enemy", x: 1000, y: groundY - 50, speed: -2, damage: 10},
          { type: "enemy", x: 1200, y: groundY - 50, speed: -2, damage: 10},
          { type: "enemy", x: 1400, y: groundY - 50, speed: -2, damage: 10},
